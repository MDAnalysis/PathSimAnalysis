...
import pathsimanalysis  # noqa



# -- Project information -----------------------------------------------------

project = "PathSimAnalysis"
copyright = (
    "2023, MDAnalysis. "
...
htmlhelp_basename = "pathsimanalysisdoc"
...
latex_documents = [
    (master_doc, "pathsimanalysis.tex", "PathSimAnalysis Documentation",
     "pathsimanalysis", "manual"),
]
